...
const Footer = () => {
  return (
    <div className="bg-neutral text-neutral-content">
      ...
      <aside>
        <h2 className="footer-title text-primary">SuezConnect</h2>
        <p>Bridging tech opportunities<br/>between the US and MENA</p>
      </aside> 
      <nav>
      ...
      <nav>
        ...
        <Link href="/contact" className="link link-hover">Schedule Call</Link>
        <Link href="/about" className="link link-hover">Team</Link>
      </nav> 
      <nav>
      ...
      <footer className="footer footer-center p-4 border-t border-neutral-600">
        <aside>
          <p>&copy; {new Date().getFullYear()} SuezConnect. All rights reserved.</p>
        </aside>
      </footer>
    </div>
  );
